class Toolchain < Formula
  ...
  url "https://github.com/CPCReady/toolchain/releases/download/v0.0.8/cpcready-toolchain-v0.0.8.tar.gz"
  sha256 "c8a2161ed4b88de20350560bcd40ff700e377913b318880995b03653aebb675f"
  license "MIT"
